...
class TransactionsController extends Controller
{
    ...
    public function submitcustomers(Request $request)
    {
        ...
        $customercount = FacadesDB::table('transactions')->where(['customer' => $customer, 'status' => false])->count();
    ...
    public function transactionslistcompleted()
    {
        $data = DB::table('transactions')->join('customers as c', 'c.id', '=', 'transactions.customer')
            ...
            ->select('c.name as cname', 'c.nic as cnic', 'c.address as caddress', 'c.mobile as cmobile',
                'c.vehiclenumber as cvehiclenumber', 'transactions.route as route',
    ...
    public function transactionslistnotcompletednew()
    {
        ...
        $data = DB::table('transactions')->join('customers as c', 'c.id', '=', 'transactions.customer')
            ...
            ->select(
                ...
                'c.mobile as cmobile',
                'c.vehiclenumber as cvehiclenumber',
                'transactions.route as route',
                'transactions.id as id',
                'transactions.paymenttype as paymenttype',
                'transactions.amount as amount',
                'transactions.installment as installment',
                'transactions.totalincome as totalincome',
                'transactions.datepurchased as datepurchased',
        ...
        $profile = DB::table('admins')->where(['id' => $id])->first();
        return view('vendor.multiauth.admin.transactionslistnotcompletednew', ['data' => $data, 'profile' => $profile]);
    }
