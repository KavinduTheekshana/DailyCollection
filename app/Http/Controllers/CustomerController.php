...
class CustomerController extends Controller
{
    ...
    public function submitcustomers2(Request $request)
    {
        ...
        $customer->vehiclenumber = $request->input('vehiclenumber');
        $customer->save();
    ...
    public function addcustomers()
    {
        ...
        $profile = FacadesDB::table('admins')->where(['id' => $id])->first();
    ...
    {
        FacadesDB::table('customers')->where('id', $id)->delete();
        return redirect()->back();
    }
    ...
    public function editcustomers(Request $request)
    {
        ...
        $customer->vehiclenumber = $request->input('modelvehiclenumber');
        $customer->save();
        // return back()->with('status', 'Customer Details Added Sucessfully');
        return redirect()->back();
    }
    ...
    public function valid_nic(Request $request)
    {
        ...
        // $status;
        $isavalible = FacadesDB::table('customers')->where('nic', $nic)->first();
