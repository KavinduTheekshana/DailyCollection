					...
					@csrf
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-3">
									<label class="control-label mb-10">ID</label>
									<input type="text" class="form-control" id="modelidedit" name="modelid" placeholder="ID" readonly>
								</div>
								<div class="col-sm-9">
									<label class="control-label mb-10">Name</label>
									<input type="text" class="form-control" id="modelnameedit" name="modelname" placeholder="Name">
								</div>
							...
							<br>
							<label for="recipient-name" class="control-label mb-10">Address</label>
							<input type="text" class="form-control" id="modeladdressedit" name="modeladdress" placeholder="Address">
							<br>
							<div class="row">
								<div class="col-sm-6">
									<label class="control-label mb-10">NIC</label>
									<input type="text" class="form-control" id="modelnicedit" name="modelnic" placeholder="NIC"
										readonly>
								</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<label class="control-label mb-10">Mobile</label>
									<input type="text" class="form-control" id="modelmobileedit" name="modelmobile" placeholder="Mobile">
								</div>
