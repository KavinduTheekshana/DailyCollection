...
<div class="page-wrapper">
									...
									<tr>
										...
										<td>
											<a href="#" id="view_msg" name="view_msg" type="button"
												...
												data-modelvehiclenumber="{{$item->vehiclenumber}}"><i class="fa fa-eye"></i></a>
											...
											<a href="#" id="edit_msg" name="edit_msg" type="button"
												...
												data-modeladdress="{{$item->address}}" data-modelnic="{{$item->nic}}"
												data-modelmobile="{{$item->mobile}}"
												data-modelvehiclenumber="{{$item->vehiclenumber}}"><i class="fa fa-pencil"></i></a>
												@endadmin
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									...
									<input type="text" class="form-control" id="modelvehiclenumber" placeholder="Vehicle Number"
										readonly>
								</div>
					...
					<form method="POST" action="{{action('CustomerController@editcustomers')}}"
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<label class="control-label mb-10">Vehicle Number</label>
									<input type="text" class="form-control" name="modelvehiclenumber" id="modelvehiclenumberedit"
										placeholder="Vehicle Nuber">
								</div>
	...
	<script>
		$('.view').on('click',function(e){
             ...
             document.getElementById('modelvehiclenumber').value=$(this).data('modelvehiclenumber');
             ...
             document.getElementById('modelvehiclenumberedit').value=$(this).data('modelvehiclenumber');
